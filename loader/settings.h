...
typedef enum loader_settings_layer_control {
    ...
    LOADER_SETTINGS_LAYER_UNORDERED_LAYER_LOCATION  // special control indicating unspecified layers should go here
...
typedef struct loader_settings_layer_environment_variable_controls {
    bool vk_layer_path;
    bool vk_instance_layers;
    bool vk_loader_layers_enable;
    bool vk_loader_layers_disable;
} loader_settings_layer_environment_variable_controls;

typedef struct loader_settings {
    bool settings_active;
    enum vulkan_loader_debug_flags debug_level;

    bool ignore_application_enabled_layers;
    bool ignore_vk_instance_layers;
    bool ignore_vk_layer_path;
    bool ignore_vk_loader_layers_disable;
    bool ignore_vk_loader_layers_enable;

    uint32_t layer_configuration_count;
    loader_settings_layer_configuration* layer_configurations;

    loader_settings_layer_environment_variable_controls layer_env_var_controls;
